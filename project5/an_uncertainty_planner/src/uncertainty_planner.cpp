#include "an_uncertainty_planner/uncertainty_planner.h"
...
void Planner_c::loadMP() {
	...
	// rosparam set /MPRIM_FILE /home/ubuntu/catkin_ws/src/student1707024/project3/an_uncertainty_planner/config/mprim.txt
...
void Planner_c::observation_callback(const an_messages::observation& msg) {
...
bool Planner_c::Init_(void) {
	...
	// subscribe to observation message
	ros::Subscriber obser_sub = nh_.subscribe("observation",1, &Planner_c::observation_callback, this);
